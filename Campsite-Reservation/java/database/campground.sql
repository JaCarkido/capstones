...
SELECT site_id
FROM reservation
WHERE (SELECT site_id FROM site WHERE campground_id = 1)
  AND site_id NOT IN ( (to_date NOT BETWEEN '2019-02-19' ::date AND '2019-02-25' ::date ) 
                 OR (from_date NOT BETWEEN '2019-02-19' ::date AND '2019-02-25' ::date  ) )
;
...
WHERE  site_id NOT IN (SELECT site_id 
               FROM reservation
               WHERE site_id IN( (to_date BETWEEN '2019-02-19' ::date AND '2019-02-25' ::date ) 
                 OR (from_date BETWEEN '2019-02-19' ::date AND '2019-02-25' ::date  ) ) )
...
SELECT site_id 
FROM site
WHERE  campground_id = 1 AND site_id NOT IN (SELECT site_id 
               FROM reservation
               WHERE ( (to_date BETWEEN '2019-02-19' ::date AND '2019-02-25' ::date ) 
               OR (from_date BETWEEN '2019-02-19' ::date AND '2019-02-25' ::date  ) )
               GROUP BY site_id)
LIMIT 5
